<%@ control language="C#" autoeventwireup="true" inherits="View_Page_ServicePlan_UserControl_AddServicePlan, App_Web_addserviceplan.ascx.8ae3ee8a" %>
...
<div class="profileData" style="border: 1px solid threedshadow; padding:15px;  height:325px;">
    ...
    <div style="float:left; width:10%">
        <telerik:RadButton ID="SaveBtn" Text="서비스플랜 추가" AutoPostBack="true"  ButtonType="LinkButton" OnClick="SaveBtn_Click" runat="server"  ></telerik:RadButton>
    </div>
</div>
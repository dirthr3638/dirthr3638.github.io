<%@ control language="C#" autoeventwireup="true" inherits="View_Page_User_UserControl_UserDetail, App_Web_userdetail.ascx.28c155c5" %>
...
<div class="demo-container size-custom mtFix" style="width:100%; height:auto">
    ...
    <div class="profileData" style="border: 1px solid threedshadow; padding:15px; height:225px;">
      <div  style="width:100%; text-align:left;">
         <telerik:RadTextBox ID="TextUserID" runat="server" Width="250px" Height="25px" Display="false">
                </telerik:RadTextBox>
            <table style ="float:left; width:90%">
             <tr>
                 
                <td><label for="UPN">UPN</label></td>
                <td><telerik:RadTextBox ID="TextUpnInput" runat="server" Width="265px" Height="25px" DisplayText="메일형식으로 입력(필수입력)" ReadOnly="true">
                </telerik:RadTextBox>
                </td>
                <td><label for="패스워드" style="margin-left:0px;">패스워드 재설정</label></td>
                <td><telerik:RadTextBox ID="TextPassword" runat="server" Width="160px" Height="25px" TextMode="Password" >
                </telerik:RadTextBox>
            ...
            <tr>
                ...
                <td><telerik:RadTextBox ID="TextDisplayName" runat="server" Width="160px" Height="25px" DisplayText="필수입력"></telerik:RadTextBox>
                <td><label for="그룹명" style="margin-left:0;">연락처</label></td>
                <td><telerik:RadTextBox Width="150px" Height="25px" ID="TextPhone" runat="server" TextMode="SingleLine" >
            ...
            <tr>               
                ...
                <td style="vertical-align:top;">
                    <telerik:RadComboBox ID="ComboUserPolicy" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ComboPolicy_SelectedIndexChanged" OnInit="ComboPolicy_Init"
         ...
         <telerik:RadButton ID="SaveBtn" Text="사용자수정" AutoPostBack="true"  ButtonType="LinkButton" OnClick="SaveBtn_Click"

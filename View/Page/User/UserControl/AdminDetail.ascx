<%@ control language="C#" autoeventwireup="true" inherits="View_Page_User_UserControl_AdminDetail, App_Web_admindetail.ascx.28c155c5" %>
...
<div class="profileData" style="border: 1px solid threedshadow; padding:15px;  height:125px;">
    <table style ="float:left; width:90%">
        <tr>
            ...
            <td><telerik:RadTextBox ID="TextAdminID" runat="server" Width="265px" Height="25px" ReadOnly="true">
            </telerik:RadTextBox>
            </td>
            <td><label for="패스워드" style="margin-left:0px;">패스워드</label></td>
            <td><telerik:RadTextBox ID="TextPassword" runat="server" Width="255px" Height="25px" TextMode="Password" >
            </telerik:RadTextBox>
        </tr>
        <tr>
            ...
            <td><label for="연락처" style="margin-left:0;">연락처</label></td>
            <td><telerik:RadTextBox Width="255px" Height="25px" ID="TextPhone" runat="server" TextMode="SingleLine"></telerik:RadTextBox></td>
        </tr>
    </table>
    <div style="float:left; width:10%">
        <telerik:RadButton ID="SaveBtn" Text="관리자수정" AutoPostBack="true"  ButtonType="LinkButton" OnClick="SaveBtn_Click" runat="server"  ></telerik:RadButton>
    </div>
</div>